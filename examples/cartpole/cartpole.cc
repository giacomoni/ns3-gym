...
NS_LOG_COMPONENT_DEFINE ("cartpole");
...
main (int argc, char *argv[])
{
  ...
  Ptr<CartpoleGymEnv> cartpoleGymEnv = CreateObject<CartpoleGymEnv> (Seconds(envStepTime));
  cartpoleGymEnv->SetOpenGymInterface(openGymInterface);
